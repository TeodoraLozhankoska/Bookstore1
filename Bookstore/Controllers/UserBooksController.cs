...
namespace Bookstore.Controllers
{
    public class UserBooksController : Controller
    {
        ...
        {
            var bookstoreContext = _context.UserBook.Include(u => u.Book);
        ...
        public async Task<IActionResult> Create([Bind("Id,AppUser,BookId")] UserBook userBook)
        {
            ...
            ViewData["BookId"] = new SelectList(_context.Book, "Id", "Publisher", userBook.BookId);
            return View(userBook);
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'BookstoreContext.UserBook'  is null.");
            }
            var userBook = await _context.UserBook.FindAsync(id);
            if (userBook != null)
            {
